...
mkdir -p /scratch/prj0000000224/models/MATH-Qwen2.5-math-7B-GRPO
...
bash run_qwen2.5-math-7b_grpo.sh \
  trainer.default_local_dir=/scratch/prj0000000224/models/MATH-Qwen2.5-math-7B-GRPO \
  "$@"
