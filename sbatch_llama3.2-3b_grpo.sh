...
mkdir -p /scratch/prj0000000224/models/MATH-Llama-3.2-3B-GRPO
...
bash run_llama3.2-3b_grpo.sh \
  trainer.default_local_dir=/scratch/prj0000000224/models/MATH-Llama-3.2-3B-GRPO \
