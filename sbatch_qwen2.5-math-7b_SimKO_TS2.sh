...
#SBATCH --job-name=simko_ts2_qwen7b
...
mkdir -p /scratch/prj0000000224/models/MATH-Qwen2.5-math-7B-SimKO-TS2
...
bash run_qwen2.5-math-7b_SimKO.sh \
  trainer.default_local_dir=/scratch/prj0000000224/models/MATH-Qwen2.5-math-7B-SimKO-TS2 \
  trainer.experiment_name="MATH-Qwen2.5-7B-SimKO-TS2" \
